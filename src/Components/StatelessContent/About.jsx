    ...
    render: function(){
        ...
        <br/>
            ...
            <div className="blogPost">
                ...
                <p>Mr. Williams is a junior full-stack developer in the Washington, DC area. A class of 2016 college graduate slow to determine his desired career path,
                ...
                <p>
                    Beyond the intricacies of software, however, he never forgets to consider the most important small unit. <em>The customer</em>.
                ...
                <p>
                    Thinking on the large scale yet acting on the small scale, Zach brings an uncommon combination of <em>broad perspective</em>, <em>attention to detail</em>, and <em>inquisitiveness</em> that can make him an asset to any
