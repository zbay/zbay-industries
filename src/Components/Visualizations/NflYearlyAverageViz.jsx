...
var yearlyAverageURL = "../../viz_data/nfl_yearly_team_averages.csv";

module.exports = React.createClass({
    componentDidMount: function(){
        this.visualize(); //default render    
    ...
    d3.csv(yearlyAverageURL, function(data){
...
chart.append("g")
    ...
    <div id="acknowledgements">
      ...
      <a href="http://www.pro-football-reference.com/" target="_blank">Pro Football Reference</a>. The derived data can be found <a href="https://github.com/zbay/zbay-industries/tree/master/public/viz_data" target="_blank">on my Github</a>.<br />
      </div>
      </div>
           ); 
    },
